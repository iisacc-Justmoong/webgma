...
const STATIC_ANALYSIS_WARNING =
  "Current static analysis maps inline styles, flex auto layout, spacing, margins, basic flex-item rules, absolute placement, image assets, and mixed text styles.";
